...
public class DisguisePlayersAdapter extends PacketAdapter {
    ...
    public void onPacketSending(PacketEvent event) {
        ...
        PlayerInfoData infoOne = new PlayerInfoData(new WrappedGameProfile(player.getUniqueId(), fakePlayer.getName()), 0, EnumWrappers.NativeGameMode.SURVIVAL, WrappedChatComponent.fromText(fakePlayer.getName()));
        ...
        if (type == PacketType.Play.Server.NAMED_ENTITY_SPAWN) {
            ...
            packet.getPlayerInfoDataLists().write(0, Lists.newArrayList(infoOne));
        }
    }
}